...
if(!empty($_POST['amount']) && !empty($_POST['narration'])){

     $str = $_POST['narration'] ."...  Topped Up by ".$_SESSION['name'];

    $data = json_encode(array(
        "beneficiaryId"  => $_POST['userid'],
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => $global_var->base_url.'/account/top-up-wallet-inward',
