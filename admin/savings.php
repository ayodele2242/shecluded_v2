...
?>
      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title mb-0">Manage Savings Goals  <a href="javascript:;" data-toggle="modal" data-target="#addAdmin" class="btn btn-sm btn-primary ml-4">Add New</a></h3>
    ...
    <div class="modal fade text-left" id="addAdmin" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="form-group">
                 <input type="text" class="form-control" placeholder="desc" name="desc" value="">
            </div>
        
             </div>
            <div class="modal-footer">
            <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Close</button>
            <button type="button" class="btn btn-outline-primary" id="createBtn">Save</button>
            </div>
            </form>
        </div>
        </div>
